...
public class ResearchPageInternalLinksTest extends AbstractWebDriverTest {
	@Test
	public void researchPageShouldNotContainInternalBrokenLinks() {
		List<WebElement> links = home.clickOnResearchLink().internalLinks;
