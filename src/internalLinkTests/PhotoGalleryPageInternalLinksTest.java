...
public class PhotoGalleryPageInternalLinksTest extends AbstractWebDriverTest {
	@Test
	public void photoGalleryPageShouldNotContainInternalBrokenLinks() {
		List<WebElement> links = home.clickOnPhotoGalleryLink().internalLinks;
